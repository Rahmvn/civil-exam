...
export const SUPPORT_FAQS = [
  ...
  },
  {
    ...
    answer: "If this followed a refresh or network interruption, resume the existing attempt. If you meant to stop, use Exit practice to end it before starting another set.",
    escalation: "The app does not let you resume or exit the active oral attempt.",
  ...
  },
  {
    ...
    answer: "Send a Payment request with the PromotionSure reference, affected module, and reason. Do not send card details, PINs, OTPs, CVVs, bank credentials, or full receipts. Refunds and disputes require payment review before any decision is made.",
    escalation: "A duplicate charge, incorrect charge, access failure, unavailable purchased content, refund request, or dispute needs payment operations review.",
