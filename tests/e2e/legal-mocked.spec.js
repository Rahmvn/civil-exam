...
test("privacy and terms are public, responsive, and accessible", async ({ page }) => {
  ...
  await expect(page.getByText(/operated by RASHEEDAH BUKOLA FAGBO/)).toBeVisible();
  await expect(page.getByText("RASHEEDAH BUKOLA FAGBO, trading as PromotionSure, Abuja, Nigeria.")).toBeVisible();
