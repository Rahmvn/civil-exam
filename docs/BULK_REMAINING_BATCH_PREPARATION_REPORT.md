...
| --- | ---: | ---: | ---: | --- | ---: | --- | ---: | --- | ---: | --- |
| public-financial-management | 3 | 30 | 20 | `contents/import-ready/public-financial-management.batch3.cleaned.json` | 20 | 20/20 matches, mismatches 0, missing 0 | 0 | DRAFT_IMPORT_CANDIDATE | 20 | Hold: undersized draft batch, review before any publish decision. |
...
- Public Financial Management Batch 3 remains a hold batch for publish planning because it is undersized at 20 questions against an expected 30.
