-- Shift practice availability from service-level-specific question pools
-- to a shared module-based question pool.
...
as $$
  ...
  select
    ...
    (
      select case
        when a2.total_questions > 0
          then round((a2.score::numeric * 100) / a2.total_questions)::integer
        else null
      end
